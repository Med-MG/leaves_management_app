  ...
  <div class="main-card mb-3 card">
    <div class="card-body">
      ...
      <div class="position-relative row form-group">
        ...
        <div class="col-sm-10">
          <input name="salary" id="usersalary" placeholder="1000" type="number" class="form-control" required />
          <div class="invalid-feedback">
      ...
      <div class="position-relative row form-group">
        ...
        <div class="col-sm-10">
          <input name="hire_date" id="userdate" type="date" class="form-control" required />
          <div class="invalid-feedback">
